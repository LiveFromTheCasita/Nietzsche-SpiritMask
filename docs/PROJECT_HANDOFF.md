...
- Latest verified public-content release: `cda35e64b71b1073dbfd7df6a1fe287e3e647299` on `main` (PR #63, expanded *Ecce Homo* guide). On 2026-09-25 the live guide showed the revised ten-review map and passage notes; the owner reviewed it and judged the book page up to standard. PR #61 (`0689bc8`) had published the four new Corpus guides; the prior *Birth of Tragedy* full-text release was `33c00c7` (PR #57). Documentation-only merges may advance `main` without changing the public content.

## Current content architecture
The repository currently contains:
- 25 theme pages under `/themes/`
- 14 book-guide/course pages under `/works/`; *The Birth of Tragedy* hub also carries an optional 19-station full-text route with nine additional lesson pages. PR #61 published guides for *Early Unpublished Essays*, *The Case of Wagner*, *Ecce Homo*, and *Nietzsche Contra Wagner* with integrated reading paths and no separate lesson chains. PR #63 expanded *Ecce Homo* to the book-guide standard accepted by the owner. The other three still need editorial-depth revision. See `FOUR_MISSING_GUIDES_REVIEW.md` and `WORK_PLAN.md`.
...
**Current status and next proposed editorial work (2026-09-25):** PR #61 closed the four missing-page gaps. PR #63 then repaired the depth of *Ecce Homo* with a complete guide route, a review-by-review walkthrough, passage notes, and edition guidance; the owner confirmed that the updated live page meets the book-guide standard. The editorial-depth work remains open for *Early Unpublished Essays*, *The Case of Wagner*, and *Nietzsche Contra Wagner*. Revise those pages proportionately without requiring identical lesson counts. Preserve the source boundaries and corrections recorded in `FOUR_MISSING_GUIDES_REVIEW.md`. A separate *Ecce Homo* lesson course is optional, not part of the current repair. The *Gay Science* optional full-text route and the remaining WP-08 expansions are still on hold behind this editorial work.
