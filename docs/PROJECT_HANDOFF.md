...
- Latest merged public-content release: `60bb715b9c8bff755cd8ac2f9282fb96f8c3f22d` on `main` (PR #67, expanded *Nietzsche Contra Wagner* guide). GitHub confirms the merge and Vercel reports successful deployment; this review did not independently inspect the post-merge live page. PR #65 (`1bc39ff`) expanded *The Case of Wagner*, and PR #63 (`cda35e6`) expanded *Ecce Homo*; the owner inspected the latter live and judged it up to standard. PR #61 (`0689bc8`) had published the four new Corpus guides; the prior *Birth of Tragedy* full-text release was `33c00c7` (PR #57). Documentation-only merges may advance `main` without changing the public content.

## Current content architecture
The repository currently contains:
- 25 theme pages under `/themes/`
- 14 book-guide/course pages under `/works/`; *The Birth of Tragedy* hub also carries an optional 19-station full-text route with nine additional lesson pages. PR #61 published guides for *Early Unpublished Essays*, *The Case of Wagner*, *Ecce Homo*, and *Nietzsche Contra Wagner* with integrated reading paths and no separate lesson chains. PR #63 expanded *Ecce Homo* to the book-guide standard accepted by the owner, and PRs #65 and #67 brought *The Case of Wagner* and *Nietzsche Contra Wagner* to comparable editorial depth after review. Only *Early Unpublished Essays* still needs revision. See `FOUR_MISSING_GUIDES_REVIEW.md` and `WORK_PLAN.md`.
...
**Current status and next proposed editorial work (2026-09-25):** PR #61 closed the four missing-page gaps. PR #63 repaired the depth of *Ecce Homo* with a complete guide route, a review-by-review walkthrough, passage notes, and edition guidance; the owner confirmed that the updated live page meets the book-guide standard. PR #65 repaired *The Case of Wagner* with a seven-stage route through the Epilogue, an argument walkthrough, 40 passage notes, and edition guidance. PR #67 repaired *Nietzsche Contra Wagner* with eight stages, an excerpt-by-excerpt provenance map, 31 passage notes, and edition boundaries. Both later revisions passed independent review before merge; Vercel reports successful deployments, though direct post-merge live inspection remains unrecorded. Editorial-depth work remains open only for *Early Unpublished Essays*. Preserve the two-essay boundary and translator distinctions recorded in `FOUR_MISSING_GUIDES_REVIEW.md`, and give both essays proportionate close treatment without requiring identical lesson counts. A separate lesson course for any completed guide would be an optional package. The *Gay Science* optional full-text route and remaining WP-08 expansions remain on hold behind this editorial work.
