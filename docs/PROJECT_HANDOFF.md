...
- Latest verified public-content release: `0689bc8339d52e8682b338fa473da2cc424bef0c` on `main` (PR #61, four new Corpus guides). On 2026-09-25 the four new guide pages were fetched from the public domain and matched the repository files byte-for-byte. The prior *Birth of Tragedy* full-text release was `33c00c76da036b9bfa616d81c099c29d9a3cb7fc` (PR #57); the earlier WP-19 content release was `3a72aec45e82ef9dde455240c87f4a843948a892` (PR #52). Documentation-only merges may advance `main` without changing the public content.

## Current content architecture
The repository currently contains:
- 25 theme pages under `/themes/`
- 14 book-guide/course pages under `/works/`; *The Birth of Tragedy* hub also carries an optional 19-station full-text route with nine additional lesson pages. The four guides for *Early Unpublished Essays*, *The Case of Wagner*, *Ecce Homo*, and *Nietzsche Contra Wagner* were published in PR #61 with integrated reading paths and no separate lesson chains. Their source and navigation corrections passed the bounded PR review, but their editorial depth falls below the ten established guides; a dedicated revision remains open. See `FOUR_MISSING_GUIDES_REVIEW.md` and `WORK_PLAN.md`.
...
**Current status and next proposed editorial work (2026-09-25):** PR #61 published dedicated guide pages for *Early Unpublished Essays*, *The Case of Wagner*, *Ecce Homo*, and *Nietzsche Contra Wagner*, closing the missing-page gap. A subsequent comparison with all ten established guides found that these four pages are substantially thinner and omit the detailed walkthroughs and passage notes that characterize the established book guides. The owner requested that the canonical records be corrected first. Treat the bounded publication package as complete and the editorial-depth revision as open; *Ecce Homo* is the recommended first revision, followed by the other three proportionately without imposing identical lesson counts. Preserve the verified edition boundaries and corrections recorded in `FOUR_MISSING_GUIDES_REVIEW.md`. The *Gay Science* optional full-text scope merged through PR #58 as documentation only; implementation remains on an owner-priority hold until the owner reprioritizes it. The other WP-08 expansions remain deferred.
