...
- 10 book-guide/course pages under `/works/`; *The Birth of Tragedy* hub also carries an optional 19-station full-text route with nine additional lesson pages. Four Corpus entries (*Early Unpublished Essays*, *The Case of Wagner*, *Ecce Homo*, *Nietzsche Contra Wagner*) do not yet have a dedicated guide.
...
**Owner priority (2026-09-24):** after the Birth pilot closeout, the next editorial assignment is dedicated guide or course treatment for *Early Unpublished Essays*, *The Case of Wagner*, *Ecce Homo*, and *Nietzsche Contra Wagner*. It has not been started and needs its own bounded assignment. Optional full-text expansions of works that already have introductory courses come only afterward. The Gay Science scope document merged through PR #58 on 2026-09-24; its optional full-text route and lessons remain on an owner-priority hold. Do not begin implementation until the owner reprioritizes it. The remaining WP-08 expansions stay deferred behind it. Completing the original ten-guide inventory did not give every Corpus entry a dedicated guide.
