...
- Latest merged public-content release: `1bc39ff9a49a984d5faf8a387eca09e0e655e7e9` on `main` (PR #65, expanded *The Case of Wagner* guide). GitHub confirms the merge and Vercel reports successful deployment; this review did not independently inspect the post-merge live page. The preceding release, PR #63 (`cda35e6`), expanded *Ecce Homo*; the owner inspected that live guide and judged it up to standard. PR #61 (`0689bc8`) had published the four new Corpus guides; the prior *Birth of Tragedy* full-text release was `33c00c7` (PR #57). Documentation-only merges may advance `main` without changing the public content.

## Current content architecture
The repository currently contains:
- 25 theme pages under `/themes/`
- 14 book-guide/course pages under `/works/`; *The Birth of Tragedy* hub also carries an optional 19-station full-text route with nine additional lesson pages. PR #61 published guides for *Early Unpublished Essays*, *The Case of Wagner*, *Ecce Homo*, and *Nietzsche Contra Wagner* with integrated reading paths and no separate lesson chains. PR #63 expanded *Ecce Homo* to the book-guide standard accepted by the owner, and PR #65 expanded *The Case of Wagner* to comparable editorial depth. *Early Unpublished Essays* and *Nietzsche Contra Wagner* still need revision. See `FOUR_MISSING_GUIDES_REVIEW.md` and `WORK_PLAN.md`.
...
**Current status and next proposed editorial work (2026-09-25):** PR #61 closed the four missing-page gaps. PR #63 repaired the depth of *Ecce Homo* with a complete guide route, a review-by-review walkthrough, passage notes, and edition guidance; the owner confirmed that the updated live page meets the book-guide standard. PR #65 then repaired *The Case of Wagner* with a seven-stage route through the Epilogue, an argument walkthrough, 40 passage notes, and edition guidance. The independent review passed before the owner merged it; Vercel reports a successful deployment, though direct post-merge live inspection remains unrecorded. Editorial-depth work remains open for *Nietzsche Contra Wagner* and *Early Unpublished Essays*. Revise these proportionately without requiring identical lesson counts. Preserve the source boundaries and corrections recorded in `FOUR_MISSING_GUIDES_REVIEW.md`. A separate lesson course for either completed guide would be an optional package. The *Gay Science* optional full-text route and remaining WP-08 expansions remain on hold behind this editorial work.
