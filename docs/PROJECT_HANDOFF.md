...
- Latest merged public-content release: `6afa10a2091c838cd9ad46bab23856e9a1979831` on `main` (PR #69, expanded *Early Unpublished Essays* guide). GitHub confirms the merge and Vercel reports successful production deployment. PR #67 (`60bb715`) expanded *Nietzsche Contra Wagner*, PR #65 (`1bc39ff`) expanded *The Case of Wagner*, and PR #63 (`cda35e6`) expanded *Ecce Homo*. The owner previously inspected *Ecce Homo* live and judged it up to standard; after the other three merged, the owner looked at them and reported all three looked quite substantial. The integration reviewer did not separately render those post-merge pages. PR #61 (`0689bc8`) published the four new Corpus guides; the prior *Birth of Tragedy* full-text release was `33c00c7` (PR #57). Documentation-only merges may advance `main` without changing the public content.

## Current content architecture
The repository currently contains:
- 25 theme pages under `/themes/`
- 14 book-guide/course pages under `/works/`; *The Birth of Tragedy* hub also carries an optional 19-station full-text route with nine additional lesson pages. PR #61 published guides for *Early Unpublished Essays*, *The Case of Wagner*, *Ecce Homo*, and *Nietzsche Contra Wagner* with integrated reading paths and no separate lesson chains. PRs #63, #65, #67, and #69 brought all four to the established book-guide depth after review, with distinct treatments of their primary texts. See `FOUR_MISSING_GUIDES_REVIEW.md` and `WORK_PLAN.md`.
...
**Current status and next proposed editorial work (2026-09-25):** PR #61 closed the four missing-page gaps. PR #63 repaired the depth of *Ecce Homo* with a complete guide route, a review-by-review walkthrough, passage notes, and edition guidance; the owner confirmed that the updated live page meets the book-guide standard. PR #65 repaired *The Case of Wagner* with a seven-stage route through the Epilogue, an argument walkthrough, 40 passage notes, and edition guidance. PR #67 repaired *Nietzsche Contra Wagner* with eight stages, an excerpt-by-excerpt provenance map, 31 passage notes, and edition boundaries. PR #69 repaired *Early Unpublished Essays* with a complete seven-stage route through its two separate texts, separate walkthroughs, 31 passage notes, and edition guidance. All four editorial-depth revisions are merged and passed independent review; Vercel reports successful deployments. The owner saw the three later guides live and reported that each looked substantial, closing the original visual-depth concern. The integration reviewer did not separately render those post-merge pages. A separate lesson course for any completed guide remains an optional package. On 2026-09-25 the owner lifted the hold on the *Gay Science* full-text route for a bounded first phase only. That phase is a route audit and three unlisted trial lessons, on `claude/gay-science-full-text-phase-1` (see `GS_FULL_TEXT_PHASE1_AUDIT.md`). It is in review and does not approve publishing the 35-station course. The remaining WP-08 expansions stay deferred pending reassessment. See `FOUR_MISSING_GUIDES_REVIEW.md` and `WORK_PLAN.md`.
