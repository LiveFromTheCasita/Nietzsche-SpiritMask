...
- Latest merged public-content release: `6afa10a2091c838cd9ad46bab23856e9a1979831` on `main` (PR #69, expanded *Early Unpublished Essays* guide). GitHub confirms the merge and Vercel reports successful production deployment; this review did not independently inspect the post-merge live page. PR #67 (`60bb715`) expanded *Nietzsche Contra Wagner*, PR #65 (`1bc39ff`) expanded *The Case of Wagner*, and PR #63 (`cda35e6`) expanded *Ecce Homo*; the owner inspected the latter live and judged it up to standard. PR #61 (`0689bc8`) published the four new Corpus guides; the prior *Birth of Tragedy* full-text release was `33c00c7` (PR #57). Documentation-only merges may advance `main` without changing the public content.
