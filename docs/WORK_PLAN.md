...
- Status: IN PROGRESS. The *Ecce Homo* guide was revised in PR #63, merged at `cda35e64b71b1073dbfd7df6a1fe287e3e647299`, and the owner reviewed the live page and judged it up to standard. *The Case of Wagner* was revised in PR #65, merged at `1bc39ff9a49a984d5faf8a387eca09e0e655e7e9`; *Nietzsche Contra Wagner* was revised in PR #67, merged at `60bb715b9c8bff755cd8ac2f9282fb96f8c3f22d`. Both passed independent editorial and structural review; Vercel reports successful deployments, but direct post-merge live inspection has not been recorded. Only *Early Unpublished Essays* remains open; see `FOUR_MISSING_GUIDES_REVIEW.md`.
- Scope: expand the published guide pages to give readers substantial, work-specific explanation and close-reading help. Revise the remaining guide proportionately, treating the two essays as distinct works. Preserve the published URL, correct source boundaries, translation guidance, and existing reading path unless a reviewed improvement requires a change.
