...
- Status: IN PROGRESS. The *Ecce Homo* guide was revised in PR #63, merged at `cda35e64b71b1073dbfd7df6a1fe287e3e647299`, and the owner reviewed the live page and judged it up to standard. *The Case of Wagner* was revised in PR #65, merged at `1bc39ff9a49a984d5faf8a387eca09e0e655e7e9` after independent editorial and structural review; Vercel reports successful deployment, but direct post-merge live inspection has not been recorded. *Nietzsche Contra Wagner* and *Early Unpublished Essays* remain open; see `FOUR_MISSING_GUIDES_REVIEW.md`.
- Scope: expand the published guide pages to give readers substantial, work-specific explanation and close-reading help. Revise the remaining two proportionately. Preserve the published URLs, correct source boundaries, translation guidance, and existing reading paths unless a reviewed improvement requires a change.
