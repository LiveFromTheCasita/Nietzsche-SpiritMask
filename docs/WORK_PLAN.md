...
- Gate: editorial review of each batch. By owner decision (2026-09-25), a timed reader trial is not required before drafting; all time ranges are labelled editorial estimates, not measured times. The present grouping stays unless later editorial evidence warrants a change. The Kaufmann comparison and real-device checks remain open. Batch 2 (stations 1, 3, 4, and 18) is drafted on `claude/gay-science-full-text-batch-2`, a separate draft PR stacked on phase 1, and is in REVIEW; see [`GS_FULL_TEXT_BATCH_2.md`](GS_FULL_TEXT_BATCH_2.md). Batch 3 (stations 5–7 and 17) is drafted on `claude/gay-science-full-text-batch-3`, a separate draft PR stacked on batch 2, and is in REVIEW; see [`GS_FULL_TEXT_BATCH_3.md`](GS_FULL_TEXT_BATCH_3.md). Batch 4 (stations 8–10, the first half of Book II) is drafted on `claude/gay-science-full-text-batch-4`, a separate draft PR stacked on batch 3, and is in REVIEW; see [`GS_FULL_TEXT_BATCH_4.md`](GS_FULL_TEXT_BATCH_4.md). Batch 5 (stations 11–13, closing Book II and opening Book III) is drafted on `claude/gay-science-full-text-batch-5`, a separate draft PR stacked on batch 4, and is in REVIEW; see [`GS_FULL_TEXT_BATCH_5.md`](GS_FULL_TEXT_BATCH_5.md). Batch 6 (stations 14–16, completing Book III's longer sections) is drafted on `claude/gay-science-full-text-batch-6`, a separate draft PR stacked on batch 5, and is in REVIEW; see [`GS_FULL_TEXT_BATCH_6.md`](GS_FULL_TEXT_BATCH_6.md). Twenty of 35 stations are now drafted (1–19, 29), none published.
