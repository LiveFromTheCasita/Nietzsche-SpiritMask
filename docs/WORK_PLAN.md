...
- Status: IN PROGRESS. The *Ecce Homo* guide was revised in PR #63, merged at `cda35e64b71b1073dbfd7df6a1fe287e3e647299`, and the owner reviewed the live page and judged it up to standard. *Early Unpublished Essays*, *The Case of Wagner*, and *Nietzsche Contra Wagner* remain open; see `FOUR_MISSING_GUIDES_REVIEW.md`.
- Scope: expand the published guide pages to give readers substantial, work-specific explanation and close-reading help. Revise the remaining three proportionately. Preserve the published URLs, correct source boundaries, translation guidance, and existing reading paths unless a reviewed improvement requires a change.
