...
The editorial-depth revision remains open for *Early Unpublished Essays*, *The Case of Wagner*, and *Nietzsche Contra Wagner*. Do not reinstate *Ecce Homo* as an unfinished guide merely because it has no separate lesson pages. A companion course would be a distinct, optional scope decision.
